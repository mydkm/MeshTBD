...
#include <cstdlib>
#include <map>
#include <optional>   // needed for QueueFamilyIndices
...
// Queue family helper (unchanged from earlier step)
...
private:
    ...
    // Declarations stay inside the class
    ...
    void pickPhysicalDevice() {
        ...
        if (res != VK_SUCCESS) {
            throw std::runtime_error("vkEnumeratePhysicalDevices (2) failed!");
        }
...
// --------- Definitions moved outside the class with proper scope ---------
...
int HelloTriangleApplication::rateDeviceSuitability(VkPhysicalDevice device) {
    ...
    // Keep the tutorial's geometry-shader requirement
